                ...
                <div className={`glass-card rounded-[2rem] px-6 sm:px-10 py-3 sm:py-4 flex items-center justify-between transition-all duration-500 ${scrolled ? 'shadow-2xl translate-y-2' : ''}`}>
                    ...
                    <div className="flex items-center gap-2 sm:gap-6">
                        ...
                        <button
                            ...
                            className="flex p-2 rounded-xl border border-white/5 text-zinc-600 hover:text-primary hover:border-primary/30 transition-all duration-500 bg-zinc-900/50"
                            title="Admin Panel"
                        >
